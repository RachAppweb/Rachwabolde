...
class CommentAndRating(models.Model):
    ...
    adminresponse = models.TextField(max_length=700, blank=True, null=True)
...
class MessagesFromUs(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        for user in users:
            mail_subject = f'{self.title} '
            message = f'مرحبا {user.first_name}\n{self.message}'
            to_email = user.email
